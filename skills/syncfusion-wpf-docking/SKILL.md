...
📄 **[Getting Started](references/getting-started.md)** — Installation, basic setup, XAML/C# examples  
📄 **[Window States](references/window-states.md)** — Dock, Float, AutoHidden, Document states  
📄 **[Docking Windows](references/docking-windows.md)** — Positioning, targeting, docking behavior  
📄 **[Floating Windows](references/floating-windows.md)** — Native float, multi-monitor, snapping  
📄 **[MDI/TDI](references/mdi-tdi-functionalities.md)** — Document modes, tab groups, tabs  
📄 **[State Persistence](references/state-persistence.md)** — Saving/loading layouts, serialization  
📄 **[Styling & Customization](references/styling-and-customization.md)** — Themes, templates, appearance  
📄 **[Advanced Features](references/advanced-features.md)** — Linked managers, nested layouts, keyboard nav
